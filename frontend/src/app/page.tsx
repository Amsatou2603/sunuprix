        ...
        <div className="relative z-10 grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
          ...
          <div className="space-y-6 lg:col-span-7">
            ...
            <p className="max-w-xl text-sm sm:text-base text-emerald-100/80 leading-relaxed">
              Suivi en temps réel et prédictions algorithmiques des prix de 12 produits de première nécessité à travers les 14 régions du Sénégal. Ancré sur des données fiables et assisté par l&apos;IA.
            </p>
          ...
          {/* Right Column: Mobile Phone Mockup & 3D Logo Emblem (Matching Image 1) */}
          <div className="relative flex items-center justify-center lg:col-span-5">
            ...
            <div className="absolute -right-2 top-4 z-20 space-y-3 hidden sm:block">
              <div className="rounded-xl border border-white/10 bg-white/10 p-3 backdrop-blur-md shadow-lg text-xs">
                <p className="text-[10px] text-gray-300 font-medium">Inflation moyenne</p>
                <p className="text-base font-extrabold text-white">2,45% <span className="text-red-400 text-xs">↑</span></p>
              </div>
              <div className="rounded-xl border border-white/10 bg-white/10 p-3 backdrop-blur-md shadow-lg text-xs">
                <p className="text-[10px] text-gray-300 font-medium">Produits suivis</p>
                <p className="text-base font-extrabold text-white">324</p>
              </div>
            </div>

            {/* Mobile Phone Mockup Frame (Version Mobile App Icon) */}
